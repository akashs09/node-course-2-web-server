...
1. Implemented search bar to search for employees through name and username to produce a narrow list
2. Added navigation buttons to the modal view when user clicks on profile and the ablity to traverse through entire collection circularly.
